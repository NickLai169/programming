...
(begin (define cs 60) '61a (define cs (+ cs 1)) cs)
; expect 61

; PROBLEMS 9-12

(lambda (c s) (begin c s (+ c s)))
; expect (lambda (c s) (begin c s (+ c s)))

(define (cs c s) (begin c s (+ c s)))
; expect cs
...
(let ((c (cs 30 30)) (s 1)) (cs c s))
; expect 61

(let ((c (cs 24 36) '61a) (s 1)) (cs c s))
; expect Error

; PROBLEM 16

(define cs (mu (c s) (+ u c b)))
; cs

(define eecs (lambda (u) (mu 30 30)))
; eecs
